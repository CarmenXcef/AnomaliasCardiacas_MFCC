...
# En el último parámetro se debe especificar si se utiliza un dataset de:
# MFCCs = MFCC
# o Diferencias = Dif
Classification.rLog('Datasets/Train/Train_5seg.csv', 'Datasets/Validation/Validation_5seg.csv', 'Dif')
# Classification.supvm('Datasets/Train/Train_5seg.csv', 'Datasets/Validation/Validation_5seg.csv', 'Dif')
# Classification.randomF('Datasets/Train/Train_5seg.csv', 'Datasets/Validation/Validation_5seg.csv', 'Dif')
"""
...
Classification.rLog('Datasets/MFCC/MFCCT_5seg.csv', 'Datasets/MFCC/MFCCV_5seg.csv', 'MFCC')
# Classification.supvm('Datasets/MFCC/MFCCT_5seg.csv', 'Datasets/MFCC/MFCCV_5seg.csv', 'x')
# Classification.randomF('Datasets/MFCC/MFCCT_5seg.csv', 'Datasets/MFCC/MFCCV_5seg.csv', 'MFCC')
"""
